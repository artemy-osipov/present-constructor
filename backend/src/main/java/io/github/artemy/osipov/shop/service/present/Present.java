...
public class Present {
    ...
    public Present(PresentModel presentModel, Collection<Candy> candies) {
        this.presentModel = presentModel;
        this.items = buildItems(presentModel, candies);
    }

    private static List<Item> buildItems(PresentModel presentModel, Collection<Candy> candies) {
