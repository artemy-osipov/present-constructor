...
public class PresentItem extends TableImpl<PresentItemRecord> {
    ...
    private static final long serialVersionUID = -890048106;
    ...
    public <O extends Record> PresentItem(Table<O> child, ForeignKey<O, PresentItemRecord> key) {
        super(child, key, PRESENT_ITEM);
    }
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.CONSTRAINT_INDEX_2, Indexes.CONSTRAINT_INDEX_29, Indexes.PRIMARY_KEY_2);
    }
    ...
    public Present present() {
        return new Present(this, Keys.CONSTRAINT_29);
    }

    public Candy candy() {
        return new Candy(this, Keys.CONSTRAINT_296);
    }
