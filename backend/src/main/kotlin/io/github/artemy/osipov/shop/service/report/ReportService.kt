...
class ReportService(
    ...
    fun generatePublicReport(presentId: UUID): Report {
        return generateReport(presentId, PUBLIC_REPORT_PATH)
    }

    fun generatePrivateReport(presentId: UUID): Report {
        return generateReport(presentId, PRIVATE_REPORT_PATH)
    }

    private fun generateReport(presentId: UUID, templatePath: String): Report {
    ...
    private fun fetchPresent(id: UUID): ReportPresent {
