...
INSERT INTO `present` (`id`, `name`, `price`, `date`) VALUES
('9744b2ea-2328-447c-b437-a4f8b57c9985', 'someName', '12.35', '2017-01-01 12:00:00');

INSERT INTO `present_item` (`id`, `present_id`, `candy_id`, `count`) VALUES
